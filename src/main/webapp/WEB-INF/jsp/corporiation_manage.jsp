...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">企业管理操作</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
                ...
                <div class="panel panel-default">
                    <div class="col-lg-12" style="background: #dddddd">
                        <table  style="border-collapse:separate; border-spacing:30px 20px;"  rules=none >
                            <tr>
                                <td style="text-align:left;" width="30%">请输入企业名关键字词(支持模糊查询)</td>
                                <td width="60%">
                                    <input  id="name_search" class = "form-control" placeholder = "若包含多个信息用逗号隔开，否则按一个处理" style="min-width: 150px;display: inline" >
                                </td>
                                <td width="10%"><button type="button" class="btn btn-primary"  onclick="mohuquery()" style="min-width: 150px;display: inline" >模糊查询</button></td>
                            </tr>
