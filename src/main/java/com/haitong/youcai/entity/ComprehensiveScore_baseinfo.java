 ...
 */
public class ComprehensiveScore_baseinfo {
    private int id;
    private String code;
    private String name;
    ...
    public Float getDatabase_java() {
        return database_java;
    }

    public void setDatabase_java(Float database_java) {
        this.database_java = database_java;
    }
}
